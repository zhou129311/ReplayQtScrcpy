...
win32 {
    ...
    INCLUDEPATH += -L$$PWD/../third_party/opencv/build/include/opencv2 \
                   -L$$PWD/../third_party/opencv/build/include
    contains(QT_ARCH, x86_64) {
        ...
        LIBS += \
                ...
                -L$$PWD/../third_party/opencv/build/x64/vc14/lib/ -lopencv_world451

        WIN_FFMPEG_SRC = $$PWD/../third_party/ffmpeg/bin/x64/*.dll

        WIN_OPENCV_SRC = $$PWD/../third_party/opencv/build/bin/*.dll
    } else {
        message("x86")
        # 输出目录
        CONFIG(debug, debug|release) {
    ...
    QMAKE_POST_LINK += $$quote($$QMAKE_COPY $$WIN_FFMPEG_SRC $$WIN_OPENCV_SRC $$WIN_DST$$escape_expand(\n\t))
