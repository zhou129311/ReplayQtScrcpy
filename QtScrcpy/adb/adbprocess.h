...
public:
    ...
    void syncExecute(const QString &serial, const QStringList &args);
    ...
    void pushReplayFile(const QString &serial, const QString &path);
    void pullReplayFile(const QString &serial, const QString &path);
    void pullImageFile(const QString &serial, const QString &name, const QString &dstPath);
    void rmScreenshotDir(const QString &serial);
    void homeKeyCode(const QString &serial);
    void forceStop(const QString &serial, const QString &name);
